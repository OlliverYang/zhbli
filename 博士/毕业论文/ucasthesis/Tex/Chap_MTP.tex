...
\section{实验评估与分析}
\begin{table}[t]
\caption{本章提出的算法在数据集 OTB2015 \cite{OTB}、VOT2018 \cite{kristan2018sixth}、GOT-10k \cite{GOT-10k}、TrackingNet \cite{muller2018trackingnet} 上的评测结果。}
\begin{center}
\begin{tabular}{c cc c}
\toprule
跟踪器 & 评价指标 & 基线方法 & 本章方法\\
\midrule
\multirow{1}{*}{OTB2015 \cite{OTB}} 
& Success & 68.3 & 69.7\\
\midrule
