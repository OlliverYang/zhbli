...
\begin{table}[t]
  ...
  \toprule
  \multirow{2}{*}[-1pt]{\begin{tabular}[c]{@{}c@{}}Way to perturb\\ the search image\end{tabular}} & \multirow{2}{*}[-2pt]{SSIM of $\delta$} & \multirow{2}{*}[-2pt]{SSIM of $p$} & \multicolumn{2}{c}{Untargeted Attack} & \multicolumn{2}{c}{Targeted Attack} \\ \cmidrule{4-7}
                                                         &                                  &                                  & AO                & SR                & AO               & SR               \\ \midrule
