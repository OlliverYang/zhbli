...
% table 2
\textbf{We have replaced ``Compared with baselines on perturbed GOT-Val dataset.'' with}
...
\textbf{in Section of the revised manuscript.}

% table 6
\textbf{We have replaced ``Contribution of each loss on GOT-Val.'' with}
\uline{``Analysis of the impact of each loss component on GOT-Val.''}
\textbf{in Section of the revised manuscript.}

% table 7
\textbf{We have replaced ``Transferability to different backbones on GOT-Val.'' with}
...
% table 8
\textbf{We have replaced ``Transferability to different tracking architectures on OTB2015.'' with}
...
% table 10
\textbf{We have replaced ``Untargeted attack: Precision score on OTB2015.'' with}
\uline{``State-of-the-art comparison of untargeted attack performance on OTB2015 in terms of precision score.''}
\textbf{in Section of the revised manuscript.}

% table 11
\textbf{We have replaced ``Targeted attack: Precision score on OTB2015.'' with}
...
\textbf{Thanks for the good commenet. As suggested, we have added the advantages \& limitations of the proposed method after experimental analysis and future works to the conclusion. For the convenience of your cross checking, the new added text is as follows:}
...
\textbf{Thanks for point out this. These experiments do not need the training phase and we have added text to clarify this. For your convenience of cross checking, the new added text is as follows:}
...
\uline{
Let us now turn to targeted attacks. In this context, we consider two scenarios:}
\begin{itemize}[itemsep= 0 pt,topsep = 0 pt]
  \item[] \uline{1. The attacker forces the tracker to follow a fixed direction. We illustrate this with 4 different directions, consisting of shifting the box by (3, 3) pixels in each consecutive frames, corresponding to the four directions 45, -45, 135, -135.}
  \item[] \uline{2. The attacker seeks for the tracker to follow a more complicated trajectory. ...}
\end{itemize}
