...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{images/state-of-art.png}
  \end{center}
  \caption{fdsafs}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{images/iter.png}
  \caption{23} 
  \label{fig:1}
\end{figure*}
